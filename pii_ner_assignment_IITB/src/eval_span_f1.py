...
def main():
    ...
    ap.add_argument("--save", default="eval_results.json",
    ...
    # Print + store results
    # ------------------------------------
    results = {"per_entity": {}, "macro_f1": None,
               "pii": {}, "non_pii": {}}
